...
void QuadrupedTask::threadCreate()
{
  ...
  pthread_setname_np(th_socket_send_, "socket_send");
...
void *QuadrupedTask::threadSocketReceive(void *arg)
{
  ((QuadrupedTask *)arg)->socketReceive();
  return NULL;
}

void *QuadrupedTask::threadSocketSend(void *arg)
{
  ((QuadrupedTask *)arg)->socketSend();
  return NULL;
}
